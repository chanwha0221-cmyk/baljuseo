...
document.addEventListener('click', e => {
  ...
  if(mk){
    ...
    /* 🪟 창을 **둘 다 여기서 연다** (홍팀장 2026-09-03).
       "버튼을 눌렀을 때 새창이 뜨면서 주소가 들어가져 있고 작업이 되는 중으로 페이지가 떴으면."
       상세메이커 안에서 상품 글을 열면 그건 **사람이 누른 직후가 아니라** 브라우저가 팝업으로 막는다.
       카드 클릭은 진짜 사용자 동작이라 그 순간에는 창 두 개가 다 열린다(실측 확인).
       ⚠️ 상품 글을 **먼저** 연다 — 뒤에 연 상세메이커가 앞으로 오게 해서, 할 일 안내가 보이는 화면에 남는다. */
