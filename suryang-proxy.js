/**
 * suryang-proxy.js — 수량관리 전용 shim (2026-09-14). sheets-proxy.js 사본, 주소만 수량 전용 웹앱(apps-script/suryang-proxy)
 * 🔴 공용 sheets-proxy.js 로 되돌리지 말 것 — 도구 20개와 한 줄에 서면 수량관리가 같이 멈춘다
 *
 * 왜 있나 (2026-08-27):
...
(function () {
  ...
  var PROXY_URL = 'https://script.google.com/macros/s/AKfycbxI0Vzt7BtnExrEkYW-HOB_BHFy_uXqmOIlF7He-yEhE_BUk8XKvfE4HDhynLFzQM8/exec';
  var SHEETS_BASE = 'https://sheets.googleapis.com/v4/spreadsheets/';
  var STORE_KEY = 'sqm_sheets_session';
  ...
  /* ⏱ 수량 전용 (2026-09-14) — 전용 웹앱은 워머가 없어 한 번 읽는 데 20~30초가 실제로 걸린다.
     15초(첫 판 10.5초)로 끊으니 마감시간 읽기가 매번 시간초과 → 마감시간이 화면에서 통째로 사라졌다. 넉넉히 준다. */
  var READ_MS = 40000, WRITE_MS = 60000, BATCH_MS = 45000;
